...
function Biblioteca() {
    ...
    const handleSongClickPlay = (e, artist, song) => {
        ...
        console.log('Biblioteca -> dispatch play-song', { artist, index, song });
        ...
        const handleArtistClick = (artist) => {
            ...
            // Disparamos el evento para que Playlist se actualice
            window.dispatchEvent(new Event('playlist-selected'));
        };
    }
    ...
    return (
        <div className='bg-[#191919] w-[412px] h-[660px] rounded-[10px] '>
            ...
            <div className="mt-4 px-5 text-white overflow-y-auto h-[420px]">
